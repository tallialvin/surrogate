...
print("\nRead Train Set")
train_dir = '/home/emu/Documents/surrogate/dataset/cs1_2000'
train_sets = GraphDataset(train_dir)

print("\nRead Test Set")
test_dir = '/home/emu/Documents/surrogate/dataset/cs1_1000'
test_set = GraphDataset(test_dir)
test_loader = DataLoader(test_set, batch_size=1, shuffle=False)

print("\nRead Val Set")
val_dir = '/home/emu/Documents/surrogate/dataset/cs1_500'
val_sets = GraphDataset(val_dir)

num_classes = train_sets.num_classes  # Since feasibility is binary (True/False)
num_features = train_sets.num_features

num_trains = [2000, 1000, 500, 100]
base_folder = "experiment_results_1/cs1_1"

for num_training in num_trains:

    print(f'\n\n>>>>>>>{num_training}<<<<<<<<<\n\n')

    model_name = "num_trains:" + str(num_training)
    ...
    for iter in range(args.iterations):
        ...
        print(f"Size of train_sets: {len(train_sets)}")
        print(f"Size of val_sets: {len(val_sets)}, num_val,{num_val} ,type {type(num_val)}")
        
        training_set, _ = random_split(train_sets, [num_training, len(train_sets) - num_training])
        validation_set, _ = random_split(val_sets, [int(num_val), len(val_sets) - num_val])

        print(f"num_training: {len(training_set)}")
        print(f"num_val: {len(validation_set)}")
        ...
        save_history_results(epoch_results, base_folder, model_name, num_iter + 1,model)
...
# dataset_dir = os.path.join('data', args.dataset)
print("\nRead Train Set")
train_dir = '/home/emu/Documents/surrogate/dataset/cs2_2000'
train_sets = GraphDataset(train_dir)

print("\nRead Test Set")
test_dir = '/home/emu/Documents/surrogate/dataset/cs2_1000'
test_set = GraphDataset(test_dir)
test_loader = DataLoader(test_set, batch_size=1, shuffle=False)

print("\nRead Val Set")
val_dir = '/home/emu/Documents/surrogate/dataset/cs2_500'
val_sets = GraphDataset(val_dir)
...
num_trains = [2000, 1000, 500, 100]
base_folder = "experiment_results_1/cs2_1"
...
# dataset_dir = os.path.join('data', args.dataset)
print("\nRead Train Set")
train_dir = '/home/emu/Documents/surrogate/dataset/cs3_2000'
train_sets = GraphDataset(train_dir)

print("\nRead Test Set")
test_dir = '/home/emu/Documents/surrogate/dataset/cs3_1000'
test_set = GraphDataset(test_dir)
test_loader = DataLoader(test_set, batch_size=1, shuffle=False)

print("\nRead Val Set")
val_dir = '/home/emu/Documents/surrogate/dataset/cs3_500'
val_sets = GraphDataset(val_dir)
...
num_trains = [2000, 1000, 500, 100]
base_folder = "experiment_results_1/cs3_1"
